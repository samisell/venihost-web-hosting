  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl overflow-hidden min-h-[300px]">
        {isLoading ? (
          <div className="flex items-center justify-center h-64 text-gray-400">Loading invoices...</div>
        ) : error ? (
          <div className="flex items-center justify-center h-64 text-red-500">Error loading invoices.</div>
        ) : (
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredInvoices.map((invoice: any) => (
                <tr key={invoice.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">
                    {invoice.currencyprefix}{invoice.total}{invoice.currencysuffix}
                  </td>
