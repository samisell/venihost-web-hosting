  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl overflow-hidden min-h-[300px]">
        {isLoading ? (
          <div className="flex items-center justify-center h-64 text-gray-400">Loading tickets...</div>
        ) : error ? (
          <div className="flex items-center justify-center h-64 text-red-500">Error loading tickets.</div>
        ) : (
                    ...
                    <div className="flex items-start gap-x-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 flex items-center text-sm leading-5 text-gray-500 gap-2">
                          ...
                          <span>•</span>
                          <span>Updated {ticket.lastreply}</span>
                        </p>
                      </div>
                    </div>
                  </div>
